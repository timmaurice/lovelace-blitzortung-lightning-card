...
| `map_zoom`                   | `number`  | **Optional.** The zoom level the map opens at, and returns to via the recenter button, when `map_auto_zoom` is `false`. Range `0`–`24` (higher is closer).                                                                                                                                  | `13`                                        |
