...
| `map_marker_style`           | `string`  | Sets the visual style for lightning strike markers on the map. Can be `'standard'`, `'crosshair'`, or `'dot'`.                          | `'standard'`                                |
